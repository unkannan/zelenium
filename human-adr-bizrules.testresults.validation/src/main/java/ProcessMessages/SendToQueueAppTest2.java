...
*/
public class SendToQueueAppTest2 {

	 
	private static final Logger LOGGER = LoggerFactory.getLogger(SendToQueueAppTest2.class);
	
	private JmsTemplate jmsTemplate;
	
	public void sendToQueue(String filename, String path, String queue) throws IOException {
		filename="./newonecheck.xml";
		path="./newonecheck.xml";
...
.withHeader("CoreId", filename).withHeader("ProductionFilename", filename).withHeader("ReceiverPartyName", senderPartyName).withHeader("MDN_DATE", new Long(System.currentTimeMillis()))
	...
	public void fun(String[] args) {
		SpringApplication.run(SendToQueueAppTest2.class, args);
