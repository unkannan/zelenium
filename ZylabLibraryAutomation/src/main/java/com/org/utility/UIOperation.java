...
import com.org.enums.AppConstantMessages;
...
public abstract class UIOperation {
     ...
     * @param xpath: locator as xpath
     */
																    protected void waitForElement(WebDriver drive,String xpath) {
																        new WebDriverWait(drive, AppConstantMessages.EXPLICIT_WAIT_TIME)
																            .until(ExpectedConditions.presenceOfElementLocated(By.xpath(xpath)));
																    }
																    
    protected void waitForElementID(String id) {
        new WebDriverWait(driver, AppConstantMessages.EXPLICIT_WAIT_TIME)
